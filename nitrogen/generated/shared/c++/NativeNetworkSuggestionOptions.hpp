...
namespace margelo::nitro::munimwifi {
  ...
  public:
    ...
    explicit NativeNetworkSuggestionOptions(std::string ssid, WifiSecurityType securityType, std::optional<std::string> passphrase, std::optional<std::string> bssid, std::optional<bool> hidden, std::optional<bool> appInteractionRequired, std::optional<EnterpriseCredentials> enterprise, std::optional<PasspointConfig> passpoint): ssid(ssid), securityType(securityType), passphrase(passphrase), bssid(bssid), hidden(hidden), appInteractionRequired(appInteractionRequired), enterprise(enterprise), passpoint(passpoint) {}
