...
namespace margelo::nitro::munimwifi {
  ...
  /**
   * A struct which can be represented as a JavaScript object (ServiceTxtEntry).
   */
  struct ServiceTxtEntry final {
  public:
    std::string key     SWIFT_PRIVATE;
    std::optional<std::string> value     SWIFT_PRIVATE;

  public:
    ServiceTxtEntry() = default;
    explicit ServiceTxtEntry(std::string key, std::optional<std::string> value): key(key), value(value) {}

  public:
    friend bool operator==(const ServiceTxtEntry& lhs, const ServiceTxtEntry& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ ServiceTxtEntry <> JS ServiceTxtEntry (object)
  template <>
  struct JSIConverter<margelo::nitro::munimwifi::ServiceTxtEntry> final {
    static inline margelo::nitro::munimwifi::ServiceTxtEntry fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::munimwifi::ServiceTxtEntry(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::munimwifi::ServiceTxtEntry& arg) {
