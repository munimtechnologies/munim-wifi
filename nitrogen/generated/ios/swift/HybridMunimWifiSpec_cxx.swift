...
open class HybridMunimWifiSpec_cxx {
  ...
  @inline(__always)
  public final func getConfiguredSSIDs() -> bridge.Result_std__shared_ptr_Promise_std__vector_std__string____ {
    do {
      let __result = try self.__implementation.getConfiguredSSIDs()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__vector_std__string___ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__vector_std__string___()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__vector_std__string___(__promise)
        __result
  ...
  @inline(__always)
  public final func disconnect() -> bridge.Result_std__shared_ptr_Promise_bool___ {
    do {
