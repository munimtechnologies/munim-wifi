///
/// Variant_NullType_IPAddressInfo.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_IPAddressInfo {
  case first(NullType)
  case second(IPAddressInfo)
}

public extension Variant_NullType_IPAddressInfo {
