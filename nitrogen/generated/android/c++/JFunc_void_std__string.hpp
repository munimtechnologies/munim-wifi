...
namespace margelo::nitro::munimwifi {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimwifi/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimwifi/Func_void_std__string_cxx;";
