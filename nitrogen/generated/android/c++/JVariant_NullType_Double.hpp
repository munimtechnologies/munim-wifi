...
namespace margelo::nitro::munimwifi {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimwifi/Variant_NullType_Double;";
  ...
  namespace JVariant_NullType_Double_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimwifi/Variant_NullType_Double$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimwifi/Variant_NullType_Double$Second;";
