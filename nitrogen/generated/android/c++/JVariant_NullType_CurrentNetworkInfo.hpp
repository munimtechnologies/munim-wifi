...
namespace margelo::nitro::munimwifi {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimwifi/Variant_NullType_CurrentNetworkInfo;";
  ...
  namespace JVariant_NullType_CurrentNetworkInfo_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimwifi/Variant_NullType_CurrentNetworkInfo$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/munimwifi/Variant_NullType_CurrentNetworkInfo$Second;";
